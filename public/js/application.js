...
$(document).on("click", ".js-msgGroup", function () {
    ...
    $(function () {
        ...
        $(window).on("resize", function () {
            ...
            $('[data-toggle="popover"]').popover({
                ...
                content: function () {
                    return '<ul class="nav nav-pills nav-stacked flex-column" style="width: 120px">' + $("#js-popoverContent").clone().html() + "</ul>"
                }
            }),
            $('[data-toggle="popover"]').on("click", function (o) {
                o.stopPropagation(),
                    $($('[data-toggle="popover"]').data("bs.popover").getTipElement()).hasClass("in") ? ($('[data-toggle="popover"]').popover("hide"), $(document).off("click.app.popover")) : ($('[data-toggle="popover"].bkf').popover("show"), setTimeout(function () {
    ...
    $(document).on("blur", '[data-action="grow"]', function () {
        if ($(window).width() > 1e3) $(this).animate({
            width: 180
        })
    }),
    (function () {
    ...
    $(function () {
        ...
        function e() {
            ...
            function t() {
                var o = a.scrollTop();
                if (!Math.max(o - e.containerTop, 0)) return $(n.find("li a")[1]).addClass("active"), n.css({
                    position: "",
                    left: "",
                    top: ""
                });
