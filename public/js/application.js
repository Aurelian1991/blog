...
$(document).on("click", ".js-msgGroup", function () {
    ...
    $(window).on("resize", function () {
        ...
        o.stopPropagation(), $($('[data-toggle="popover"]').data("bs.popover").getTipElement()).hasClass("in") ? ($('[data-toggle="popover"].login').popover("hide"), $(document).off("click.app.popover")) : ($('[data-toggle="popover"].login').popover("show"), setTimeout(function () {
