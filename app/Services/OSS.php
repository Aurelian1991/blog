...
//
//  // 经典网络 or VPC
//  private $networkType = env('OSS_NETWORK_TYPE');
//
//  private $AccessKeyId = env('OSS_ACCESS_KEY_ID');
//  private $AccessKeySecret = env('OSS_ACCESS_KEY_SCERET');
  ...
  {
      $this->city=env('OSS_CITY')??'上海';
      $this->networkType=env('OSS_NETWORK_TYPE')??'';
      $this->AccessKeyId=env('OSS_ACCESS_KEY_ID')??'';
      $this->AccessKeySecret=env('OSS_ACCESS_KEY_SCERET')??'';
